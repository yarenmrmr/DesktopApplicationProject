...
{
    public partial class OpenTickets : Form
    {
...

        {
            ...
            conn.Open();
            SqlDataAdapter adp = new SqlDataAdapter("select * from dbo.Tickets where TicketStatusId=1", conn);
            adp.Fill(tablo);
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ticketGroup();
            this.Hide();
            OpenTicketsInfo openTicketsInfo = new OpenTicketsInfo();
            openTicketsInfo.ShowDialog();
        }
    }
}
