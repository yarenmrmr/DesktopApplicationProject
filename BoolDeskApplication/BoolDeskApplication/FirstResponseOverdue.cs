...
{
    public partial class FirstResponseOverdue : Form
    {
...

        {
            ...
            conn.Open();
            SqlDataAdapter adp = new SqlDataAdapter("select * from dbo.Tickets where FirstResponseOverdue=1", conn);
            adp.Fill(tablo);
        ...
        private void FirstResponseOverdue_Load(object sender, EventArgs e)
        {
            listele();
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ticketGroup();
            this.Hide();
            ResponseOverdueInfo responseOverdueInfo = new ResponseOverdueInfo();
            responseOverdueInfo.ShowDialog();
        }
    }
}
