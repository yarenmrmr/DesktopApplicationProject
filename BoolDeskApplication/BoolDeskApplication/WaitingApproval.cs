...
{
    public partial class WaitingApproval : Form
    {
...

        {
            ...
            conn.Open();
            SqlDataAdapter adp = new SqlDataAdapter("select * from dbo.Tickets where TicketStatusId=3", conn);
            adp.Fill(tablo);
        ...
        private void WaitingApproval_Load(object sender, EventArgs e)
        {
            listele();
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ticketGroup();
            this.Hide();
            WaitingApprovalnfo waitingApprovalnfo = new WaitingApprovalnfo();
            waitingApprovalnfo.ShowDialog();  
        }
    }
}
