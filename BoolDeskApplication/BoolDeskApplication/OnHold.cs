...
namespace BoolDeskApplication
{
    public partial class OnHold : Form
    {
...

        {
            ...
            conn.Open();
            SqlDataAdapter adp = new SqlDataAdapter("select * from dbo.Tickets where TicketStatusId=7", conn);
            adp.Fill(tablo);
        ...
        private void OnHold_Load(object sender, EventArgs e)
        {
            listele();
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ticketGroup();
            this.Hide();
            OnHoldInfo onHoldInfo = new OnHoldInfo();
            onHoldInfo.ShowDialog();
        }
    }
}
