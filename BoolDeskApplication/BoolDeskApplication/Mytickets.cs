...
namespace BoolDeskApplication
{
    public partial class Mytickets : Form
    {
        ...
        string id = YoneticiGirisEkrani.kid;
...

        {
            ...
            conn.Open();
            SqlDataAdapter adp = new SqlDataAdapter("select * from dbo.Tickets where CreatedById='"+id+"'", conn);
            adp.Fill(tablo);
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ticketGroup();
            this.Hide();
            MyTicketsInfo myTicketsInfo = new MyTicketsInfo();
            myTicketsInfo.ShowDialog();
        }
    }
}
